...
public class SpecialFlowerBlock extends FlowerBlock implements ITileEntityProvider, IWandable, IWandHUD {
    ...
    public SpecialFlowerBlock(Effect stewEffect, int stewDuration, Properties props, Supplier<? extends TileEntitySpecialFlower> teProvider) {
